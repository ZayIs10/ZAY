...
Usage:
    python scripts/setup/setup_reels_sheet.py             # creates "Reels" tab
    python scripts/setup/setup_reels_sheet.py --tab-name Reels   # custom name
"""
...
REELS_COLUMNS = [
    ...
    "Reel Caption",                 # on-screen card text (no hashtags)
    "Post Caption",                 # IG text-box caption (with hashtags)
